                            ...
                            content: FutureBuilder(
                              ...
                              builder: (context, snapshot) {
                                if (snapshot.hasData) {
                                  ...
                                  final first = (list?.length ?? 0) >= 1
                                      ? (list?[0])
                                      : null;
                                  final second = (list?.length ?? 0) >= 2
                                      ? (list?[1])
                                      : null;
                                  final third = (list?.length ?? 0) >= 3
                                      ? (list?[2])
                                      : null;
                                  return Column(
                                    crossAxisAlignment:
                                              ...
                                              child: ListTile(
                                                  leading: Row(
                                                    ...
                                                    children: [
                                                      IconButton(
                                                          onPressed: () {
                                                            context.read<LeaderboardBloc>().add(const LeaderboardEvent.exit());
                                                          },
